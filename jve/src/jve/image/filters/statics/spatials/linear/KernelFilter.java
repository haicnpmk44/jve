 ...
 *
 */
package jve.image.filters.statics.spatials.linear;
 ...
 *
 */
public class KernelFilter extends SpatialFilter {
	 ...
	 * @param image
	 */
	public KernelFilter(Mask m, BufferedImage image ) {
		super(m, image , "Convolution Filter");
	}
	 ...
	 *
	 */
	public KernelFilter(BufferedImage image) {
		super(null, image , "Convolution Filter" );
		Mask ma = new Mask(3);
		ma.setAll(1);
		this.setMask(ma);
	}
