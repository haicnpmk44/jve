...
import jve.image.filters.statics.pontuals.aritimetics.DIVFilter;
import jve.image.filters.statics.pontuals.aritimetics.MAXFilter;
import jve.image.filters.statics.pontuals.aritimetics.MINFilter;
import jve.image.filters.statics.pontuals.aritimetics.MULTFilter;
import jve.image.filters.statics.pontuals.aritimetics.SUBFilter;
import jve.image.filters.statics.pontuals.logical.ANDFilter;
import jve.image.filters.statics.pontuals.logical.IGSFilter;
import jve.image.filters.statics.pontuals.logical.NOTFilter;
import jve.image.filters.statics.pontuals.logical.ORFilter;
import jve.image.filters.statics.pontuals.logical.XORFilter;
import jve.image.filters.statics.spatial.nolinear.DeSpeckellFilter;
import jve.image.filters.statics.spatial.nolinear.MedianFilter;
import jve.image.filters.statics.spatial.nolinear.RoadFilter;
import jve.image.filters.statics.spatials.SpatialFilter;
import jve.image.filters.statics.spatials.linear.BorderDetectFilter;
import jve.image.filters.statics.spatials.linear.KernelFilter;
import jve.image.filters.statics.spatials.linear.LaplacianGaussinanFilter;
