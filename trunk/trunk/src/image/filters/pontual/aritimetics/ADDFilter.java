...
public class ADDFilter implements PointFilter {
	private static String name = "Filtro Soma";
	 ...
	 * @param cons
	 */
	public ADDFilter(BufferedImage image1 , BufferedImage image2 , int cons ){
		this.image1 = image1;
		this.image2 = image2;
		this.constant = cons;
	}
	...
	/**
	 * Build a filter that add two images
	 *
	 * @param image1
	 * @param image2
	 */
	public ADDFilter(BufferedImage image1 , BufferedImage image2){
		this.image1 = image1;
		this.image2 = image2;
		this.constant = 0;
	}
	 ...
	 * @param cons
	 */
	public ADDFilter(BufferedImage image1 , int cons){
		this.image1 = image1;
		this.image2 = null;
		this.constant = cons;
	}
